        ...
        StorageService.shared.uploadImageMessage(photo: image, to: chat) { result in
            ...
            case .success(let url):
                ...
                FirestoreService.shared.sendMessage(chat: self.chat, message: message) { result in
                    ...
                    case .failure(_):
                        self.showAlert(with: "Error!", and: "Message didn't send")
                    }
                }
            case .failure(let error):
                self.showAlert(with: "Error!", and: error.localizedDescription)
...
extension ChatsViewController {
    ...
    func configureSendButton() {
        ...
        messageInputBar.sendButton.tintColor = UIColor(named: "projectColor")
    ...
    func configureCameraIcon() {
        ...
        cameraItem.tintColor = UIColor(named: "projectColor")
