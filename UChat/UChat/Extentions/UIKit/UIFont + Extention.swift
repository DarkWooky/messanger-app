...
extension UIFont {
    ...
    static func helvetica26() -> UIFont? {
        return UIFont.init(name: "helvetica", size: 26)
    }
    
    static func helveticaNeueMedium20() -> UIFont? {
        return UIFont.init(name: "Helvetica Neue Medium", size: 20)
    }
    
    static func helveticaNeue18() -> UIFont? {
